...
@Component({
  selector: 'app-withdraw-records',
  templateUrl: './withdraw-records.page.html',
  styleUrls: ['./withdraw-records.page.less']
})
export class WithdrawRecordsPage implements OnInit {
  type;
  moment = moment;
